...
namespace AStar
{
    ...
    public class AStarFinder
    {
        ...
        public AStarFinder(byte[,] map, int xStart, int yStart, int xTarget, int yTarget)
        {
            _mapArr = map;
        ...
        public void Find()
        {
            ...
            PrepareAroundNode(_start);
            var around = getAroundNodes(_start);
            foreach (var t in around)
            {
                openList.Add(t);
            }
            
            closeList.Add(_start);
